...
app.config({
    ...
    $('[data-provide~="demo-color-changer"]').each(function () {
        var a = $(this).data("target"), c = $(this).data("base-class"), d = "", e = $(this).dataAttr("name", ""),
            f = $(this).dataAttr("checked", ""), g = $(this).dataAttr("exclude", ""), h = "";
        ...
        var b = $(this).val().trim(), c = $(".tab-pane:not(#tab-search-result) .demo-icons-list li"),
            d = $("#icon-tabs").length;
